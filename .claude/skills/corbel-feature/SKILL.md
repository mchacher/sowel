...
name: corbel-feature
description: |
  Creates features for Corbel — a home automation engine. Use when:
  - User asks to "create a feature", "implement X", "add VX.Y" for Corbel
  - Working on a roadmap version (V0.1, V0.2, etc.)
  - User says "créer une feature", "ajouter une fonctionnalité", "implémenter"
  Specific to Corbel project: MQTT, devices, equipments, zones, scenarios, recipes, AI assistant.
---

# Corbel Feature Workflow
...
| Document | Purpose |
|----------|---------|
| `docs/corbel-spec.md` | Full specification — the single source of truth |
...
## Reference
- Spec sections: §X, §Y (reference corbel-spec.md sections)
...
|----------|----------------|
| `docs/corbel-spec.md` | Mark completed items, add any spec clarifications discovered during implementation |
...
## Roadmap
- Implements V0.X from corbel-spec.md
...
| Purpose | Location |
|---------|----------|
| Full specification | `docs/corbel-spec.md` |
...
| Reset DB | `rm data/corbel.db && npm run dev` |
