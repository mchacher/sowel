...
Une tuile qui affiche une **puissance** en watts (prise avec mesure, chauffe-eau, panneau solaire, compteur) ne l'affiche que tant que la mesure est récente. Au-delà, le chiffre laisse place à un tiret et la tuile indique l'âge de la dernière mesure, plutôt que de présenter une valeur que la maison n'a aucune raison de mettre en doute. Le délai est de deux minutes pour un compteur déclaré, qui remonte en continu, et de dix minutes pour le reste, car plusieurs intégrations interrogent leur source toutes les cinq minutes. Une tuile solaire retire aussi le courant et la tension avec la puissance, les trois venant du même onduleur ; elle se distingue alors de la mention **Veille** affichée la nuit. C'est la même règle que la décomposition de consommation de la page Énergie.
