...
- Maintenance (api) : **les derniers corps de requête validés à la main passent au schéma** (#837, issue #597). Les corps de widgets avaient été reportés parce qu'ils dépendent du type de widget ; les recherches d'existence restent dans le handler et conservent leur statut d'origine, convertir une vérification de forme n'étant pas une raison de renuméroter une réponse dont un client peut dépendre.
