...
- **Une main sur l'interrupteur mural** → _confirmation interrupteur_ détecte la divergence durable entre décision et réalité et suspend l'arbitrage pour cette charge ; le journal le dit. Une suspension répond à cet **événement**, pas à l'état qu'il laisse derrière lui : une charge laissée en marche hors arbitrage vaut une suspension, et le même état inchangé n'en arme jamais une seconde. Sinon le délai de reprise manuelle expirait sur une suspension identique une minute plus tard, indéfiniment, et la charge ne pouvait plus jamais être reprise — « reprendre le pilotage » compris, annulé 62 s après chaque appui. Pour la même raison, une charge sur laquelle une demande attend n'est pas suspendue : une demande doit tenir la _persistance de la demande_ avant d'être accordée, soit le double de la confirmation interrupteur, donc la suspendre refusait précisément la demande qui aurait mis fin à la contradiction.
