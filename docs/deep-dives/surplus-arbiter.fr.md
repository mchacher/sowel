...
- **Il échoue du bon côté.** Si le compteur devient muet, l'arbitre cesse d'accorder. Si l'état réel d'une charge contredit sa décision — quelqu'un a utilisé l'interrupteur mural — il se retire plutôt que de se battre contre le mur.
...
| Puissance nominale (W)   | —      | Le budget utilisé tant qu'il n'y a pas assez de marches pour apprendre la consommation réelle. Obligatoire.                                                                                                                                      |
...
| Délai d'extinction (min) | global | Le temps que la charge met à réellement s'arrêter après un retrait — la tempo de 30 minutes d'un chauffe-eau thermodynamique, par exemple. L'arbitre continue de budgéter cette puissance au lieu de l'allouer deux fois.                        |
