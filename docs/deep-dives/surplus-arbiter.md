...
- **It fails safe.** If the grid meter goes silent, the arbiter stops granting. If a load's real state contradicts its decision — someone used the wall switch — it backs off rather than fighting the wall.
...
| Nominal power (W)    | —       | The budget used until enough runs exist to learn the real draw. Required.                                                                                                                                                  |
