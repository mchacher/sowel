define(["exports"], function (t) {
  ...
  class o {
    ...
    handleRequest({ request: t, event: e }) {
      ...
      let a;
      try {
        a = o.handle({ url: s, request: t, event: e, params: r });
      } catch (t) {
        a = Promise.reject(t);
      }
  ...
  class m {
    ...
    async cachePut(t, e) {
      ...
      if (!o) return !1;
      const { cacheName: c, matchOptions: a } = this.u,
        ...
        f = l
          ? await (async function (t, e, s, n) {
            ...
            })(h, r.clone(), ["__WB_REVISION__"], a)
          : null;
      try {
        await h.put(r, l ? o.clone() : o);
      } catch (t) {
        if (t instanceof Error)
          throw (
    ...
    async getCacheKey(t, e) {
      ...
      if (!this.h[s]) {
        ...
        for (const t of this.iterateCallbacks("cacheKeyWillBeUsed"))
          n = R(await t({ mode: e, request: n, event: this.event, params: this.params }));
        this.h[s] = n;
      }
      return this.h[s];
    }
  ...
  ((t.NavigationRoute = class extends r {
    ...
    (t.NetworkOnly = class extends v {
      constructor(t = {}) {
        (super(t), (this.D = t.networkTimeoutSeconds || 0));
      }
      async L(t, e) {
        let n, r;
        try {
          const s = [e.fetch(t)];
          if (this.D) {
            const t = u(1e3 * this.D);
            s.push(t);
          }
          if (((r = await Promise.race(s)), !r))
            throw new Error(`Timed out the network response after ${this.D} seconds.`);
        } catch (t) {
          t instanceof Error && (n = t);
        }
    ...
    (t.createHandlerBoundToURL = function (t) {
      return P().createHandlerBoundToURL(t);
    }),
